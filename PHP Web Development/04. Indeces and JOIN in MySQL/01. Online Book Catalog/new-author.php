...
?>
    ...
    <div><a href="index.php">Book Catalog</a> | <a href="new-book.php">New Book</a> | <b>New Author</b><br><br></div>
...
if (isset($_POST['new-author']))
{
    ...
    if (!$error)
    {
        $author = htmlspecialchars(mysqli_real_escape_string($CONNECTION, $author));

namespace Poker.Tests.PokerHandsChecker
{
    ...
    public class IsTwoPairMethod
    {
        ...
        public void TestOnHandWithNoCards()
        {
            ...
            var expected = false;
            var actual = this.pokerHandsChecker.IsTwoPair(handWithNoCards);
        ...
        public void TestOnHandWithFourDifferentCardsOnEqualSuit()
        {
            ...
            var expected = false;
            var actual = this.pokerHandsChecker.IsTwoPair(handWithFiveDifferentCardsOnEqualSuit);
            Assert.AreEqual(expected, actual);
        }
        ...
        public void TestOnHandWithTwoEqualOfFiveCardsOnEqualSuit()
        {
            ...
            var expected = false;
            var actual = this.pokerHandsChecker.IsTwoPair(handWithTwoEqualOfFiveCardsOnEqualSuit);
            Assert.AreEqual(expected, actual);
        }
        ...
        public void TestOnHandWithSixDifferentCards()
        {
            ...
            var expected = false;
            var actual = this.pokerHandsChecker.IsTwoPair(handWithSixDifferentCards);
            Assert.AreEqual(expected, actual);
        }
        ...
        public void TestOnHandWithTwoEqualCards()
        {
            ...
            var expected = false;
            var actual = this.pokerHandsChecker.IsTwoPair(handWithTwoEqualCard);
            Assert.AreEqual(expected, actual);
        }
        ...
        public void TestOnHandWithFiveEqualCards()
        {
            ...
            var expected = false;
            var actual = this.pokerHandsChecker.IsTwoPair(handWithFiveEqualCards);
            Assert.AreEqual(expected, actual);
        }
        ...
        public void TestOnHandWithTwoEqualPairOfCards()
        {
            ...
            var expected = false;
            var actual = this.pokerHandsChecker.IsTwoPair(handWithTwoEqualPairOfCards);
            Assert.AreEqual(expected, actual);
        }
        ...
        public void TestOnHandWithTwoEqualOfFourCards()
        {
            ...
            var expected = false;
            var actual = this.pokerHandsChecker.IsTwoPair(handWithTwoEqualOfFourCards);
            Assert.AreEqual(expected, actual);
        }
        ...
        public void TestOnHandWithTwoEqualOfSixCardsWithDifferentFaces()
        {
            ...
            var expected = false;
            var actual = this.pokerHandsChecker.IsTwoPair(handWithTwoEqualOfSixCards);
            Assert.AreEqual(expected, actual);
        }
        ...
        public void TestOnHandWithTwoEqualOfSixCardsOnEqualSuit()
        {
            ...
            var expected = false;
            var actual = this.pokerHandsChecker.IsTwoPair(handWithTwoEqualOfSixCardsOnEqualSuit);
            Assert.AreEqual(expected, actual);
        }

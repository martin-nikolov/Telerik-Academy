...
static class PhonebookApp
{
    static void Main()
    {
        var phoneTextFileContent = GetFileTextContent("../../phones.txt");
        var commandsTextFileContent = GetFileTextContent("../../commands.txt");
    ...
    static IList<Subscriber> ExtractSubscribers(string text)
    {
        ...
        {
            var subcriber = line.Split(new char[] { '|' },
    ...
    static IList<List<string>> ExtractCommands(string text)
    {
    ...
    static void ExecuteCommands(Phonebook phonebook, string text)
    {
    ...
    static void PrintResult(ICollection<Subscriber> subscribers, string name, string town = null)
    {

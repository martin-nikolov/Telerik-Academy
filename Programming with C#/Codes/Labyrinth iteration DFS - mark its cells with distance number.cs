...
class LabyrinthIterationDFS
{
    ...
    static void Main()
    {
        ...
        {
            Cell currentCell = visitedCells.Pop();
    ...
    static void VisitCell(Stack<Cell> visitedCells, int row, int col, int distance)
    {
        ...
        if (labyrinth[row, col] == "0" || distance == 0)
        {
            ...
            visitedCells.Push(new Cell(row, col, distance));
        }
    }

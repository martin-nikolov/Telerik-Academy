    ...
    static void Main()
    {
        ...
        do
        {
            ...
            while (Console.KeyAvailable)
            {
                ...
                {
                    player = new PlayerPosition(player.x, player.y - (playerMoveSteps == 2 ? playerMoveSteps : playerMoveSteps + 1));
                }
                else if (userKey.Key == ConsoleKey.RightArrow && player.y + 4 < Console.WindowWidth)
                {
                    player = new PlayerPosition(player.x, player.y + (playerMoveSteps == 2 ? playerMoveSteps + 1 : playerMoveSteps));
                }

...
function Main(bufferElement) {
    ...
    WriteLine("Case sensitive: " + allOccursLength(text, pattern, false, false));
    WriteLine("Case insensitive: " + allOccursLength(text, pattern, false, true));

    WriteLine();
    WriteLine("Searching a part of word: ")
    WriteLine("Case sensitive: " + allOccursLength(text, pattern, true, false));
    WriteLine("Case insensitive: " + allOccursLength(text, pattern, true, true));
}

function allOccursLength(str, pattern, isSubstring, isCaseSensitive) {
    var caseSensitive = isCaseSensitive ? "gi" : "g";

...
function Main(bufferElement) {
    ...
    var properties = [ "First name", "Last name", "Grade" ];

    $(container).append(generateTable(students, properties));
    ...
    var properties = [ "First name", "Last name", "Age", "Specialty" ];

    $(container).append(generateTable(teachers, properties));
...
function generateTable(collection, properties) {
    ...
    for (item in collection) {            
        ...
        for (property in collection[item]) {
